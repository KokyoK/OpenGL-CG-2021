...
Camera::Camera() : wKey(0), sKey(0), aKey(0), dKey(0),zKey(0),xKey(0), currentButton(0), mouseX(0), mouseY(0)
{
	Reset();
}
...
//	eyePosition[2] = 0.5f * static_cast<float>(Scene::GetWindowHeight()) / static_cast<float>(tan(M_PI / 6.0)) - 0.1;//0.0f;
    eyePosition[2] = 800.0f;
